...
| `preferences_read` / `preferences_write` | — / preferences | `Preferences { dailyFolder? }`; write returns what was stored, and refuses a folder outside the Folio | config |
