...
| `src-tauri/src/commands/<domain>.rs` | One file per command domain (`app`, `folio`, `index`, `spell`, `sync`, `project`; later `snapshots`, `compile`) |
