...
| `src-tauri/src/config.rs` | The Folio's `.aml/config.yaml` (ADR-010): settings as dotted paths, written back as nested YAML one per line, keeping anything this version does not know |
